...
CREATE TABLE TBL_CAR(
	...
	CAR_BRAND VARCHAR2(225),
	CAR_RELEASE_DATE DATE,
	CAR_COLOR VARCHAR(225),
	CAR_PRICE NUMBER
);
...
-- 컬럼 추가(성별)
ALTER TABLE TBL_ANIMAL ADD ANIMAL_GENDER VARCHAR2(255);
-- 컬럼 이름 수정
ALTER TABLE TBL_ANIMAL RENAME COLUMN ANIMAL_SEX TO ANIMAL_GENDER;
-- 컬럼 삭제
ALTER TABLE TBL_ANIMAL DROP COLUMN ANIMAL_GENDER;
-- 컬럼 수정(자료형)
ALTER TABLE TBL_ANIMAL MODIFY ANIMAL_GENDER NUMBER;
ALTER TABLE TBL_ANIMAL MODIFY ANIMAL_GENDER VARCHAR2(255);
-- 테이블 삭제
